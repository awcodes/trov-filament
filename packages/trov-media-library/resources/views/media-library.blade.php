<div x-data="{
    ...
    <x-filament::modal id="trov-media-gallery"
        width="7xl"
        ...
        <div class="flex h-full"
            ...
            <div class="flex-1 pr-6">
                @if ($files)
                    <ul class="grid grid-cols-3 gap-4 sm:grid-cols-4 md:grid-cols-6">
            ...
            <div class="flex-shrink-0 w-full max-w-xs pl-6 border-l border-gray-300 dark:border-gray-700">
