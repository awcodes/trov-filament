<x-filament::layouts.base :title="$title">
    <div class="flex w-full min-h-screen filament-app-layout">
        <div x-data="{}"
            x-cloak
            ...
            <header @class([
                ...
                <div @class([
                    ...
                    <button x-data="{}"
                        ...
                        class="flex items-center justify-center w-10 h-10 rounded-full shrink-0 text-primary-500 filament-sidebar-open-button hover:bg-gray-500/5 focus:bg-primary-500/10 focus:outline-none lg:hidden">
